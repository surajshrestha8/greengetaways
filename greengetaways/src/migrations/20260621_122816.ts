...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_events_event_type" AS ENUM('festival', 'workshop', 'trek-departure', 'cultural', 'environmental', 'community', 'seasonal');
  ...
  CREATE TABLE "events" (
  	...
  	"location_region" varchar,
  	"pricing_is_free" boolean DEFAULT false,
  ...
  ALTER TABLE "events" ADD CONSTRAINT "events_related_tour_id_tours_id_fk" FOREIGN KEY ("related_tour_id") REFERENCES "public"."tours"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "events_related_tour_idx" ON "events" USING btree ("related_tour_id");
